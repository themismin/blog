...
<div class="wrapper">
    ...
    <header class="main-header">
        ...
        <a href="{{ url('manage/' )}}" class="logo">
            ...
            <span class="logo-lg"><b>Mingo</b>&nbsp;Blog</span>
        </a>
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li class="user-footer">
                                ...
                                <div class="pull-right">
                                    <a href="{{ url('manage/logout') }}" class="btn btn-default btn-flat">退出</a>
                                </div>
                            </li>
                        </ul>
                    </li>
    ...
    <aside class="main-sidebar">
        ...
        <section class="sidebar">
            <!-- Sidebar user panel -->
            @inject('managePresenter', 'App\Presenters\ManagePresenter')
