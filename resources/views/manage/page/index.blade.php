            ...
            <div class="box box-solid">
                <div class="box-header">
                    <div class="pull-right">
                        <a href='{{ route("manage.page.create") }}' class='btn btn-success btn-xs'>
                        ...
                        @if($pages)
                            @foreach($pages as $page)
                                <tr>
                                    ...
                                    <td>{{ $page->desc }}</td>
                                    <td>
                                        <a href='{{ route("manage.page.edit", ["id" => $page->id]) }}' class='btn btn-info btn-xs'>
                                            <i class="fa fa-pencil"></i> 修改</a>
                                        <a data-href='{{ route("manage.page.destroy", ["id" => $page->id]) }}'
