...
use App\Models\User;
use App\Http\Requests\Manage\User\CreateRequest;
...
class UserController extends Controller
{
    ...
    public function store(CreateRequest $request)
    {
        ...
        return redirect()->route('manage.user.index')->with('success', '用户添加成功');
    }
    ...
    public function update(UpdateRequest $request, $id)
    {
        ...
        return redirect()->route('manage.user.index')->with('success', '用户修改成功');
    }
