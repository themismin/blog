...
use App\Http\Requests\Manage\Category\CreateRequest;
use App\Http\Requests\Manage\Category\UpdateRequest;
...
class CategoryController extends Controller
{
    ...
    public function index()
    {
        ...
        return view("manage.category.index", compact('category'));
    }
    ...
    public function store(CreateRequest $request)
    {
        ...
        return redirect(route('manage.category.index'))->with('success', '添加成功');
    }
    ...
    public function update(UpdateRequest $request, $id)
    {
        ...
        return redirect(route('manage.category.index'))->with('success', '分类修改成功');
    }
