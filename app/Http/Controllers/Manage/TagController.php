...
use App\Http\Requests\Manage\Tag\CreateRequest;
use App\Http\Requests\Manage\Tag\UpdateRequest;
use App\Models\Tag;
...
class TagController extends Controller
{
    ...
    public function store(CreateRequest $request)
    {
        ...
        return redirect()->route('manage.tag.index')->with('success', '标签添加成功');
    }
    ...
    public function update(UpdateRequest $request, $id)
    {
        ...
        return redirect()->route('manage.tag.index')->with('success', '标签修改成功');
    }
