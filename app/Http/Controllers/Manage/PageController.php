...
use App\Http\Requests\Manage\Page\CreateRequest;
use App\Http\Requests\Manage\Page\UpdateRequest;
use App\Models\Page;
...
class PageController extends Controller
{
    ...
    public function store(CreateRequest $request)
    {
        ...
        return redirect()->route('manage.page.index')->with('success', '创建成功');
    }
    ...
    public function update(UpdateRequest $request, $id)
    {
        ...
        return redirect()->route('manage.page.index')->with('success', '修改成功');
    }
