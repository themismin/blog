...
use Auth;
use App\Http\Requests\Manage\Article\CreateRequest;
use App\Http\Requests\Manage\Article\UpdateRequest;
...
class ArticleController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('manage.article.index', compact('articles'));
    }
    ...
    public function store(CreateRequest $request)
    {
        ...
        return  redirect()->route('manage.article.index')->with('success', '文章添加成功');
    }
    ...
    public function edit($id)
    {
        ...
        return view('manage.article.edit', compact('article'));
    }
    ...
    public function update(UpdateRequest $request, $id)
    {
        ...
        return redirect()->route('manage.article.index')->with('success', '文章修改成功');
    }
